...
const Arrival_ItemRight=()=>{
    return(
      <div style={{backgroundColor:'whitesmoke',height:'50px',width:'50px',borderRadius:'50%',marginTop:'160px',marginBottom:'160px'}}>
          <ArrowForwardIosRounded style={{marginLeft:'12px',marginRight:'12px',marginTop:'13px',marginBottom:'10px'}}/>
      </div>
    )
}
export default Arrival_ItemRight